...
> **Estado em 17/09/2026:** 19 das 27 perguntas respondidas, 53 conclusões (33 firmes, 13 prováveis,
> 7 indícios), das quais **14 negativas**. **Nenhuma validada** — todas são rascunho até o dono
> validar o texto. As 8 que faltam estão TODAS bloqueadas; ver `_fonte/CONTEXTO_sessao_17_09.md` §4.
> Nada commitado, nada publicado.

Leia este arquivo antes de começar qualquer parte. Ele diz o que já foi respondido,
com que confiança, e o que cada parte acrescentou ao que já existia.

Escrito só no fim de cada parte, pelo fluxo principal (nunca por subagente).

## Conclusões registradas

| ID | Manchete | Confiança | n | Indicadores que passaram no critério |
|----|----------|-----------|---|--------------------------------------|
| A01-1 | Subir custa 63 pontos, e esse número quase não muda | firme (contagem) | 4 temporadas | pontos do 4º, aproveitamento, vitórias |
| A01-2 | O acesso se decide por um ponto | firme (contagem) | 4 temporadas | margem 4º–5º |
| A01-3 | Metade de quem sobe termina colado na linha | firme (contagem) | 80 clube-temporadas | fronteira, Trave, dist_g4 |
| A05-1 | *Parece, mas não é:* Não existe estilo com bola que separe quem sobe | firme | 80 clube-temporadas | ver A05.md |
| A05-2 | Times sobem com estilos opostos — e no mesmo ano | firme | 16 promovidos | ver A05.md |
| A07-1 | *Parece, mas não é:* Correr não separa quem sobe: nem no volume, nem na intensidade, nem com ou sem bola | firme | 80 clube-temporadas | ver A07.md |
| A07-2 | Quem cai sprinta menos — e o sprint que falta é sem a bola | provável | 16 rebaixados contra 48 do meio | ver A07.md |
| A11-1 | Não é correr: é correr para onde | firme | 80 clube-temporadas | ver A11.md |
| A11-2 | A corrida sem bola vira pressão, mas não vira bola recuperada | provável | 80 clube-temporadas | ver A11.md |
| A11-3 | *Parece, mas não é:* O físico não separa quem sobe nem entre times de nível técnico parecido | provável | 80 clube-temporadas em alta, média | ver A11.md |
| A12-1 | Das nove réguas, só quatro separam quem sobe — e duas delas não são de jogo | firme | 80 clube-temporadas | ver A12.md |
| A12-2 | O Cenário Barato parece funcionar, mas a conta é circular — e 2026 não confirma | indício | 4 promovidos fora do top-8, e 20 times de 2026 | ver A12.md |
| A12-3 | O perfil, como está escrito na especificação, exclui metade dos times de que foi derivado | firme | 4 casos | ver A12.md |
| A13-1 | Quem cai não despenca: já estava mal na metade e afundou depois | firme | 80 clube-temporadas | ver A13.md |
| A13-2 | Na metade, 7 em cada 10 já estão na faixa em que vão terminar — mas virar acontece todo ano | firme | 80 clube-temporadas | ver A13.md |
| A13-3 | *Parece, mas não é:* O 1º turno prevê menos do que parece: rho 0,48, não 0,82 | firme | 80 clube-temporadas | ver A13.md |
| A14-1 | Oito indicadores resumem o Bloco A, e a ordem das faixas sai limpa | provável | 80 clube-temporadas | ver A14.md |
| A14-2 | O índice só se sustenta em metade das temporadas | firme | 4 temporadas, 4 contra 12 em cada | ver A14.md |
| A14-3 | Em 2026, a régua acerta em cheio os dois que sobem direto | indício | 20 times de 2026, rodada 27 | ver A14.md |
| A04-1 | *Parece, mas não é:* bola parada não separa quem sobe | firme | 80 clube-temporadas | nenhum dos 13, nos dois cortes |
| A04-2 | Um terço dos gols da Série B sai de bola parada, e a fatia é igual para todos | firme (descrição) | 80 clube-temporadas | — |
| A04-3 | Quem cai perde a bola parada dos dois lados | provável | 16 × 48 | duelos_aereos_pct (d −1,16) |
| A03-1 | *Parece, mas não é:* nenhum time depende de casa mais que os outros | firme | 80 clube-temporadas | nenhum dos 24 testes de assimetria passou |
| A03-2 | A vantagem defensiva de quem sobe aparece igual dentro e fora de casa | firme (nos dois cortes) | 16 × 48 e 8 × 32 | xgc_casa, dd_casa, dd_fora |
| A03-3 | Quem cai cria menos em casa e sofre mais fora | provável | 12 × 32 | xg_casa, xgc_fora |
| A06-1 | Quem sobe não pressiona mais alto — ganha mais duelo no chão | firme | 8 × 32 | duelos_def_pct (d 1,59) |
| A06-2 | O duelo defensivo é a única coisa que separa quem sobe de quem ficou na trave | provável | 8 × 7 | duelos_def_pct (d 2,23) |
| A06-3 | Quem sobe não cede menos chutes — cede chutes piores | firme | 8 × 32 | xg_por_remate_contra (d 1,30) |
| A02-1 | Quem sobe não finaliza mais nem sofre menos finalização — finaliza e sofre de outro lugar | firme | 8 × 32 sem fronteira | dist_remate, toques_area, entradas_area, xg_contra, xg_por_remate_contra |
| A02-2 | O lado que mais separa é o defensivo | firme | 8 × 32 | xg_contra (d 1,46), xg_por_remate_contra (d 1,30) |
| A02-3 | *Parece, mas não é:* pontaria e goleiro não são característica | firme | 80 clube-temporadas | porta temporal: finalizacao rho 0,19; defesa_vs_xg rho −0,09 |
| T02-1 | No G4 quem manda é o tamanho do elenco, não o nome do treinador | firme (contagem) | 151 passagens | %G4 por faixa de valor do elenco |
| T02-2 | Um treinador só repete G4 em clubes diferentes: Eduardo Baptista | provável | 134 rodadas | %G4, ppj, saldo de xG |
| T02-3 | *Parece, mas não é:* histórico de G4 não se transfere de clube | firme (contagem) | 34 treinadores | amplitude do %G4 |
| T01-1 | Time da Série B troca de treinador duas vezes por ano, e só 3 em cada 10 terminam a temporada com quem começou | firme (contagem, não teste) | 188 clube-temporadas | — (coleta, sem indicador) |
| T01-2 | Treinador de Série B roda entre clubes: 29 comandaram dez rodadas ou mais em três clubes diferentes | firme (contagem) | 193 treinadores | — |
| T01-3 | O nome do treinador deixou de ser o que não dá | firme | 506 passagens-temporada | — |

As três nascem como **rascunho** e só sobem para "O que decidimos" depois de validadas pelo dono.

## Status das partes

| ID | Pergunta (resumo) | Status | Depende de |
|----|-------------------|--------|------------|
| E00 | Criar a aba Estudo Série B | **feita** (17/09) | — |
| A01 | Base e régua: o que separa as faixas | **rascunho** (17/09) | — |
| A02 | Ataque ou defesa | **rascunho** (17/09) | A01 |
| A03 | Casa e fora | **rascunho** (17/09) | A01, A06 |
| A04 | Bola parada | **rascunho** (17/09) | A01 |
| A05 | Estilo com bola | **rascunho** (17/09) | A01 |
| A06 | Sem bola | **rascunho** (17/09) | A01, A02 |
| A07 | Físico: volume ou intensidade | **rascunho** (17/09) | A01 |
| A08 | Físico dentro do jogo | pendente | A01 |
| A09 | Momentos do jogo | pendente | A01 |
| A10 | Físico ao longo da temporada | pendente | A01 |
| A11 | Físico e técnico | **rascunho** (17/09) | A01 |
| A12 | Estilos de jogo e destino | **rascunho** (17/09) | A05–A07, réguas §7.2 |
| A13 | Trajetória | **rascunho** (17/09) | A01 |
| A14 | Síntese e teste 2026 | **rascunho** (17/09) | A02–A13 |
| T01 | Coleta de passagens de treinador | **rascunho** (17/09) | — (a coleta não dependeu de A01) |
| T02 | Rodadas no G4 | **rascunho** (17/09) | T01, A01 |
| T03 | Perfil de jogo do treinador | pendente | A14 |
| T04 | Treinador ideal | pendente | A14, T02, T03 |
| J01 | Base e minutagem | pendente | A01 |
| J02 | Rotação e continuidade do elenco | pendente | A01 |
| J03 | O titular de quem sobe: técnico | pendente | J01 |
| J04 | O titular de quem sobe: físico | pendente | J01 |
| J05 | Perfil ideal por posição | pendente | A14, J03, J04, §8 |
| J06 | Alvos na Série B | pendente | A14, J03, J04, §8 |
| J07 | Estrangeiros na Série B | pendente | J01 |
| J08 | Conversão de ligas | pendente | J01, base das ligas |
| J09 | Alvos no exterior | pendente | J05, J06, J08 |
| R01 | Aposentar Análise Série B e Protótipo | pendente | A01–A07, A12, A14, aba no ar |
...
| ID | Manchete | Confiança | n | Indicadores que passaram |
|----|----------|-----------|---|---------------------------|
| J04-1 | *Parece, mas não é:* O titular de quem sobe também é fisicamente indistinguível do titular do meio | provável | 697 titulares com físico, de 907 (2022–2025) | **nenhum** |
| J04-2 | *Parece, mas não é:* Os dois sinais físicos que sobraram são do recorte, não do futebol | indício | idem | — |
| J04-3 | O físico é a medida que mais se repete no jogador — e mesmo assim não aponta quem sobe | indício | idem | — |
...
|----|----------|-----------|---|
| J08-1 | *Parece, mas não é:* Não existe conversão por liga estrangeira — e não vai existir com esta base | firme | 737 mudanças, 591 jogadores |
| J08-2 | *Parece, mas não é:* A escada entre as divisões brasileiras não sobrevive a quem realmente trocou de clube | **indício** | 238 no corte estrito |
| J08-3 | Quem chega guarda menos da metade do destaque que tinha, venha de onde vier | firme | 737 |
...
| ID | Manchete | Confiança | n |
|----|----------|-----------|---|
| A10-1 | *Parece, mas não é:* Não existe queda de returno na Série B para medir — e quem subiu em 2025 não sustenta nada de diferente | provável | 47 × 135 jogadores (4 × 12 clubes) |
| A10-2 | Em semana de três jogos o time não corre menos — o que parece cair é o ponto, e isso ainda é indício | indício | 20 clubes, 61 jogos curtos, 280 jogadores |
| A10-3 | Quem caiu em 2025 sprinta menos no returno — e o que muda é o elenco, não a perna | provável, **marcada "pode ser efeito do placar"** | 71 × 199 |
