...
| J03-2 | O duelo defensivo de quem sobe aparece na conta do time, não numa posição | indício | no time, {n_a06_s} temporadas de quem sobe contra {n_a06_m} do meio (8 contra 32 sem os times colados na linha); no jogador, {n_usado} titulares em {setores} setores (456 sem esses times) |
