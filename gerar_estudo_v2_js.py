...
DOCS = [
    ...
    ("Recomendação", "seriea", "listas/SERIE_A_OPORTUNIDADES.md", "Série A: não aproveitados e fim de contrato"),
    ...
    ("Blocos", "b10", "resultados/b10/B10.md", "10 · Treinador e modelo de jogo"),
    ("Blocos", "b11", "resultados/b11/B11.md", "11 · Conversão de liga"),
    ("Blocos", "b12", "resultados/b12/B12.md", "12 · Treinador: sorte × mérito"),
    ("Blocos", "b13", "resultados/b13/B13.md", "13 · Patamar de Série A"),
    ("Blocos", "b14", "resultados/b14/B14.md", "14 · Sofascore jogo a jogo"),
    ("Blocos", "b15", "resultados/b15/B15.md", "15 · Sugestões pelo tipo físico (lista)"),
