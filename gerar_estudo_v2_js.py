...
DOCS = [
    ...
    ("Listas de nomes", "ideal", "listas/IDEAL_2027.md", "Os meus dez por posição"),
    ("Listas de nomes", "top10", "listas/TOP10_POR_POSICAO.md", "Dez alvos por posição (livres primeiro)"),
    ("Listas de nomes", "listas", "listas/LISTAS.md", "Listas por posição e mercado"),
    ("Listas de nomes", "fisico", "listas/RANKING_FISICO.md", "Ranking físico por posição"),
    ("Listas de nomes", "b15", "resultados/b15/B15.md", "Sugestões pelo tipo físico (B15)"),
    ("Listas de nomes", "bolaparada", "listas/BOLA_PARADA.md", "Especialistas de bola parada"),
    ("Listas de nomes", "livres", "listas/ELENCO_2027_LIVRES_B_ARG.md", "Só livres (B + ARG)"),
    ("Listas de nomes", "seriea", "listas/SERIE_A_OPORTUNIDADES.md", "Série A: jovens, veteranos, Remo/Chape"),
    ("Listas de nomes", "emprestimos", "listas/EMPRESTIMOS_EXTERIOR.md", "Empréstimos do exterior"),
    ("Listas de nomes", "treinadores", "listas/TREINADORES.md", "Treinadores: lista para avaliação"),
    ("Listas de nomes", "nao", "listas/NAO_CONTRATAR.md", "Quem não contratar"),
