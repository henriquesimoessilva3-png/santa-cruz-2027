...
const ESTUDO_SERIEB = {
 ...
 "ranking": {
  ...
  "o_que_e": "Ordena por ADERÊNCIA à ficha da posição — o quanto o jogador se parece com o titular de quem subiu. NÃO é probabilidade de dar certo: o perfil descreve quem subiu e não promete quem vai subir (J05-1), e o backtest da §8.6 não autorizou publicar nome como alvo.",
  "serie_b": [
   {
    "posicao": "Goleiro",
