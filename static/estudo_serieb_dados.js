...
const ESTUDO_SERIEB = {
 ...
 "partes": [
   ...
   "conclusoes": [
    {
     ...
     "o_que_vimos": "Na Série B, a vantagem de jogar em casa é de 0,79 ponto por jogo e não distingue quem sobe de quem fica no meio — a exceção é o grupo de 5º a 8º, só no placar e num corte só. Nenhum dos 24 testes de casa menos fora viu diferença entre as faixas, e nenhum tinha amostra para ver.",
     ...
     "grafico": {
      "tipo": "grupos",
      "titulo": "xG sofrido a mais longe de casa",
      "unidade": "xG por jogo",
      "series": [
       {
        "nome": "Sobe",
  ...
  },
  {
   ...
   "feita_em": null,
   "prova_arquivos": "scripts/_rodar.py A07 (tabela de testes); resultados/A07_numeros_novos.json (desconto do rodízio, rodada de cobertura e conversão para posições)"
  },
  {
   "id": "A08",
   "bloco": "A",
  ...
  },
  {
   ...
   "conclusoes": [
    ...
    },
    {
     ...
     "o_que_vimos": "No 1º turno os rebaixados já correm 618 metros em alta intensidade por noventa minutos contra 690 do meio, e isso só aparece comparando cada um dentro do próprio setor. Não é cansaço, é elenco: quem caiu usou 35,9 atletas por meia temporada contra 29,1 de quem subiu.",
     "para_o_santa_cruz": "O risco da temporada longa não é o elenco cansar, é o elenco não ter o nível e ainda virar outro no meio do ano — o que conversa com as premissas m2 e m3. Núcleo fixo e minutagem concentrada valem mais que reforço de meio de temporada. Na régua de contratação (J05), sprint e alta intensidade entram como corte de nível do elenco inteiro, e não como prova de resistência para o fim do campeonato.",
     "premissa": "m3",
  ...
  },
  {
   ...
   "conclusoes": [
    ...
    },
    {
     ...
     "o_que_vimos": "A faixa publicada é pressão de 10,0 a 13,2, posse de 47% a 52% e bola longa de 10% a 14%. Cobrada assim, o Vitória de 2023 fica fora por 52,0153% contra o teto de 52% e a Chapecoense de 2025 por 14,0858% contra o teto de 14%. Dos quatro, só pressionar pouco é comum.",
     ...
     "grafico": {
      "tipo": "grupos",
      "titulo": "Os quatro times em pressão, posse e bola longa",
      "unidade": "lugar na liga",
      "series": [
       {
        "nome": "Mais pressão",
        "valor": 13
       ...
       {
        "nome": "Mais bola longa",
        "valor": 3
       },
       {
        "nome": "Menos bola longa",
        "valor": 19
       }
      ]
     }
   ...
   "conclusoes": [
    {
     ...
     "confianca": "indício",
     "confianca_motivo": "Indício porque não passa em nenhum dos dois critérios. (a) Correção para múltiplos testes a 5% dentro da família: NÃO — A13_testes.csv não existe, scripts/A13.py não importa scripts/_metodo.py e nenhum q foi calculado em lugar nenhum da parte; quando a auditoria de 18/09 rodou a família de três (Cai×Meio, Cai×Sobe e permutação dos turnos dentro do time) sobre a diferença entre turnos, q deu 0,42 nos três e nenhum passou. (b) Porta temporal da §6.4: NÃO — o desfecho é a faixa final, e os pontos do 1º turno já estão somados nela (_porta_temporal.md registra A13 como a porta sem o desconto, com o desfecho contaminado). Zero de dois = indício. O que sustenta o indício é o tamanho do déficit, que sobrevive aos dois cortes (19,5 contra 25 nas 80 campanhas, 19 contra 24 nas 52) e tem uso prático imediato na janela de julho. Duas ressalvas para a prova: o tombo do returno tem efeito observado de -0,32 contra um mínimo detectável de 0,82, ou seja, este desenho não o enxerga; e o corte sem os clube-temporadas de base incompleta, que o script prometia e nunca rodou, confirma o déficit — as medianas de quem cai ficam idênticas, 19,5 no 1º turno e 17 no 2º. Três coisas ficam aqui nesta passada, e a terceira volta ao texto sem os números. Os dois cortes do déficit agora estão no gráfico desta conclusão, lado a lado. No corte sem os times de fronteira, 11 dos 12 rebaixados ficam abaixo da mediana do meio e 4 dos 12 fizeram mais pontos no returno. E a mediana da diferença entre turnos de quem subiu vai de 1 ponto nas 80 campanhas para -2 nas 52 sem esses times — troca de sinal, a única da parte entre os dois cortes, e por isso ela voltou ao texto: contagem sem teste, com o 1º turno já somado no desfecho, e por isso indício. Nesta passada ela voltou como dependência de amostra, e não como afirmação seca de que a melhora vira piora: a inversão se apóia em oito campanhas, as que sobram de quem subiu quando se tiram os times de fronteira. E a comparação de quem caiu é contra a marca do meio, 25 pontos: os 15 dos 16 ficaram abaixo dela, não abaixo da própria mediana de quem caiu — abaixo dos 19,5 são oito dos 16.",
   ...
   "conclusoes": [
    {
     ...
     "o_que_vimos": "Clube com elenco entre os cinco mais caros passa, em média, 14,6 rodadas no G4 por temporada; do 11º elenco para baixo, 3,2. A distância que a conta sustenta é a dos cinco mais caros contra o 11º para baixo; o degrau do meio não se separa do acaso.",
   ...
   "conclusoes": [
    {
     ...
     "premissa": "m2",
     "premissa_motivo": "Ajusta a m2 (“Muitos minutos por temporada”): minutagem alta e repetida continua valendo, mas “alta” se mede dentro da posição — no corte único a premissa exclui o ataque por construção, porque só {reg_atk} atacantes em quatro temporadas a cumprem.",
     "confianca": "indício",
  ...
  },
  {
   ...
   "conclusoes": [
    ...
    },
    {
     ...
     "parte": "J03",
     "bloco": "J",
     "manchete": "O duelo defensivo de quem sobe aparece na conta do time, não numa posição",
     "o_que_vimos": "No time, quem sobe ganha 0,98 ponto percentual a mais de duelo defensivo que o meio. Posição por posição não sobra nada, nem no volante, que é a maior e não se distingue da conta do time. No gol, e só sem os times de fronteira, o goleiro de quem sobe ganha menos.",
     ...
     "grafico": {
      "tipo": "grupos",
      "titulo": "Duelo defensivo ganho por posição · volante e zaga, nenhuma diferença firme",
      "unidade": "%",
      "series": [
       {
        "nome": "Sobe · volante",
   ...
   "conclusoes": [
    {
     ...
     "parte": "J07",
     "bloco": "J",
     "manchete": "Quem sobe dá 10,6% dos minutos a estrangeiro, quase o triplo do meio",
     "o_que_vimos": "63 das 80 clube-temporadas já tiveram estrangeiro, e a liga usa 2,3 por clube, longe das 9 do regulamento. É retrato de agora, não das quatro temporadas: o uso quase triplicou desde 2022, até 10,4% dos minutos da liga, e em 2023 quem subiu usou menos estrangeiro que o meio.",
    ...
    },
    {
     ...
     "parte": "J07",
     "bloco": "J",
     "manchete": "Um ano depois, só 26,6% dos estrangeiros seguem na liga, contra 51,1% dos brasileiros",
     "o_que_vimos": "Recortados igual, estrangeiro e brasileiro estreiam jogando o mesmo: 16,6% contra 16,5% dos minutos. O empate depende de contar 2022, quando a liga inteira era estreante; sem ele a vantagem do estrangeiro volta. Seguir na liga é reaparecer na Série B, não ficar no clube.",
     "para_o_santa_cruz": "O estrangeiro não chega com vantagem de minuto: ele entra no time como entra o brasileiro contratado no mesmo ano, e quem esperava que ele viesse para jogar mais está comprando uma diferença que não existe. O que pesa na conta é a saída — 1 em cada 4 segue na Série B no ano seguinte, contra 1 em cada 2 do brasileiro —, então contrato, janela de saída e custo de reposição têm de ser montados para uma temporada. Ressalva que muda o uso: sair da Série B inclui quem subiu para a Série A ou foi para fora do país, então parte dessa rotatividade é venda, não fracasso, e esta parte não sabe separar as duas.",
     "premissa": null,
     "premissa_motivo": "Sugere premissa nova: contratar estrangeiro na Série B é aposta de uma temporada — ele estreia com a mesma fatia de minutos do brasileiro que chega no mesmo ano (16,6% contra 16,5%) e só 26,6% reaparecem na liga no ano seguinte, contra 51,1% dos brasileiros. Derruba a premissa implícita do texto publicado até aqui, de que o estrangeiro chega com passe adiantado no time.",
     "confianca": "indício",
     "confianca_motivo": "Indício: são contagens, não testes — resultados/J07_testes.csv não existe, nenhum q foi calculado e o cabeçalho de scripts/J07.py declara que aqui não há teste de hipótese nem BH. A porta temporal do 1º turno prevendo o 2º também não rodou, e o que esta conclusão olha é o ano seguinte, que é outra coisa. Duas ressalvas de leitura: a permanência mede \"reapareceu na Série B\", não \"ficou no clube\", e o alvo é montado sobre as 3.864 linhas da base — montado só sobre as linhas que casaram nacionalidade, o estrangeiro dá 25,5% em vez de 26,6%. Além disso, 43,5% da coorte estrangeira é de 2025 e só pode ser julgada contra 2026, a temporada de pior cobertura e ainda em curso (2022: 95,8% · 2023: 96,3% · 2024: 94,0% · 2025: 93,2% · 2026: 84,5%). Sobre a estreia: a vantagem de minuto do estrangeiro (18,1% contra 16,8%) só existe na coorte frouxa, em que chegar era aparecer na base pela primeira vez, e some quando os dois lados são recortados por quem entrou no clube naquele ano (16,6% contra 16,5%). O empate desse recorte estrito depende de 2022 estar dentro, e sem ele o resultado INVERTE: só com 2023-2025 a distância volta a 4,2 pontos, 19,4% do estrangeiro contra 15,2% do brasileiro, em 94 casos de estrangeiro — quem decide contratação lê isso como \"o estrangeiro ainda estreia jogando mais\", e é por isso que a ressalva está também no o_que_vimos e não só aqui. Esses 19,4 e 15,2 existem hoje só dentro do de_onde de pri_est_nc em J07_numeros_novos.json, sem marcador próprio, e entram na re-rodada. Na passada de 20/09 o gráfico desta conclusão mostrava a estreia, que a manchete não afirma; agora ele mostra a permanência, que é o achado do título, e a estreia voltou para a frase. A contagem bruta de quem reapareceu continua sem marcador próprio, em em_aberto.",
    ...
    },
    {
     ...
     "parte": "J07",
     "bloco": "J",
     "manchete": "Quase todo estrangeiro da Série B é sul-americano, 159 dos 184 casos",
     "o_que_vimos": "Sete em cada dez casos: Argentina 43, Colômbia 37, Uruguai 34, Paraguai 20. Por jogador, não por temporada, a Colômbia lidera, e a base traz a nacionalidade, não a liga. No mesmo cruzamento, brasileiro com segundo passaporte (177) quase empata com estrangeiro de fato (184).",
     "para_o_santa_cruz": "Onde procurar é a vizinhança: Argentina, Colômbia, Uruguai e Paraguai. São essas as quatro ligas de que J08 precisa primeiro do fator de conversão, e é delas que J09 monta a lista — e, para montar lista de alvo, a contagem que vale é a de pessoas (148, com a Colômbia na frente), não a de temporadas. Ressalva que muda o uso: a base tem a nacionalidade, não a liga de onde o jogador veio — um argentino pode ter chegado de clube brasileiro —, então isso diz de que país é o mercado, não de que campeonato se compra.",
     "premissa": null,
     "premissa_motivo": "Sugere premissa nova: o mercado de estrangeiro da Série B é sul-americano — Argentina, Colômbia, Uruguai e Paraguai respondem por 72,8% dos casos e 70,3% dos jogadores —, e é dessas quatro ligas que o fator de conversão de J08 precisa primeiro. E derruba a premissa implícita de que o passaporte europeu é usado ao contrário: contados no mesmo cruzamento, dupla nacionalidade com o Brasil (177 casos) e estrangeiro de fato (184) aparecem quase 1 para 1 — o contraste 40 x 11 que sustentava a frase era artefato do cruzamento de nomes.",
     "confianca": "indício",
     "confianca_motivo": "Cai de firme para indício. O \"firme\" publicado se apoiava em \"contagem completa das cinco temporadas\", e isso não se sustenta: a janela do estudo é 2022-2025, a contagem não é completa (94,8% das linhas da janela casaram nacionalidade) e o motivo de confiança publicava cobertura de 81,7% enquanto todos os outros números da mesma conclusão vinham de um cruzamento com 94,8%. Pelos dois critérios também não passa: não há resultados/J07_testes.csv nem q calculado — scripts/J07.py declara que aqui não há teste de hipótese nem BH — e contagem de nacionalidade não tem versão por turno, então a porta temporal do 1º turno prevendo o 2º não rodou. A origem sai por nacionalidade e não por liga: clube_anterior dá o clube, não a liga, e um argentino pode ter vindo de clube brasileiro. A Europa quase não aparece dos dois jeitos de contar: Portugal, com 7 casos e 6 jogadores, é o único europeu com mais de um. O gráfico desta conclusão ficou numa unidade só, casos de estrangeiro por temporada, porque as duas contagens não são a mesma medida e não cabem na mesma régua: a barra são os 159 sul-americanos e a linha tracejada, o total de 184 casos. Por pessoa, e não por temporada, são 125 de 148, com a Colômbia na frente (Colômbia 33, Argentina 28, Uruguai 28, Paraguai 15). A linha de corte é o único valor escrito à mão em vez de marcador, porque o formato do gráfico não resolve marcador nesse campo: ela tem de ser atualizada junto com total_est na re-rodada. E a ressalva de contagem que muda o uso: contados no mesmo cruzamento, o brasileiro com segundo passaporte (177 casos) e o estrangeiro de fato (184) praticamente empatam — o contraste 40 x 11 que sustentava a ideia de que na Série B o passaporte europeu era usado ao contrário era artefato do cruzamento de nomes. Essa ressalva voltou para o texto de tela, no o_que_vimos, porque é ela que manda J09 separar os dois lados antes de contar vaga. Duas coisas que o dado desta parte NÃO diz e que saíram daqui na conferência de 20/09: não há fonte nenhuma, nem no de_onde de dupla_lin nem em premissas.json, para a regra de que dupla nacionalidade com o Brasil não ocupa vaga de estrangeiro — premissas.json só fixa o limite de 9 no elenco —, e a contagem de dupla nacionalidade não sustenta o \"a vaga não está sobrando\" de J07-1, que se apoia nos 2,3 por clube e nas 63 de 80 clube-temporadas.",
  ...
  },
  {
   ...
   "conclusoes": [
    ...
    },
    {
     ...
     "premissa": null,
     "premissa_motivo": "Não trata de nenhuma premissa de dados/premissas.json. Corrige uma leitura de graça anotada no _registro.md em 19/09 (\"quem sobe da Série C para a B perde 0,59 de nível\"), que não é premissa do app — e esse 0,59 é a média simples da base de {n_linhas} linhas ({dqz_brasil_c}), não o coeficiente do modelo, que é −0,39.",
     "confianca": "indício",
