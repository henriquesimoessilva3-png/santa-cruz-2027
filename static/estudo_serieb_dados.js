/* GERADO POR gerar_estudo_serieb_js.py - NAO EDITE A MAO.
   ...
   Gerado em: 2026-09-20 - partes respondidas: A01, A02, A03, A04, A05, A06, A07, A10, A11, A12, A13, A14, J01, J02, J03, J04, J07, J08, T01, T02, T03, T04
*/
const ESTUDO_SERIEB = {
   ...
   "conclusoes": [
    {
     ...
     "parte": "A01",
     "bloco": "A",
     "manchete": "Subir custa 64 pontos: 63 teria ficado de fora em 2 das 4 temporadas",
     "o_que_vimos": "O 4º colocado fechou com 62 (2022), 64 (2023), 64 (2024) e 62 (2025), com 16 a 19 vitórias; nas quatro temporadas anteriores, que estão na base mas fora do recorte desta parte, fechou com 60, 62, 61 e 64, com 15 a 18 vitórias. Um elenco montado para 63 pontos teria ficado fora do G4 em 2023 e em 2024 — e também em 2021 —, três das oito temporadas da base, e na temporada em curso o 4º vai em ritmo de 66 pontos. É contagem completa das tabelas, sem teste e sem leitura à frente do resultado, e o corte muda conforme os anos que se olham: por isso vale como indício.",
     ...
     "confianca": "indício",
     "confianca_motivo": "Indício porque não passa em nenhum dos dois critérios da régua. (1) Correção para múltiplos testes (Benjamini-Hochberg a 5% por família): não há o que corrigir — não existe A01_testes.csv e scripts/A01.py não importa scripts/_metodo.py; as únicas contas da parte são contagem e mediana sobre os pontos do 4º e do 17º. (2) Porta temporal da §6.4 (1º turno prevendo o 2º): não rodou em A01, e _porta_temporal.md registra que nenhuma das 19 partes a rodou. Há ainda motivo material: a faixa de 62 a 64 é propriedade das 4 temporadas do recorte — nas quatro anteriores o corte vai de 60 a 64, e o ritmo de 2026 está em 66.",
    ...
    },
    {
     ...
     "parte": "A01",
     "bloco": "A",
     "manchete": "O acesso se decide por um ponto — e quem desempata é a vitória, não o saldo",
     "o_que_vimos": "A margem do 4º para o 5º foi de 4 (2022), 1 (2023), 0 (2024) e 1 (2025): um ponto ou menos em 3 das 4 temporadas, e cinco das oito somando as quatro anteriores da base, onde as margens foram 0, 1, 3 e 2. Em 2024 Ceará e Novorizontino terminaram os dois com 64 pontos e o acesso saiu na contagem de vitórias, 19 contra 18, sem chegar ao saldo de gols; em 2018 foi igual, e mais claro — o Goiás subiu com 60 pontos e saldo de 4, à frente da Ponte Preta, com os mesmos 60 pontos e saldo de 12. É contagem completa das tabelas, sem teste por trás: por isso vale como indício.",
    ...
    },
    {
     ...
     "parte": "A01",
     "bloco": "A",
     "manchete": "8 dos 16 que subiram terminaram colados na linha — por isso toda comparação roda duas vezes",
     "o_que_vimos": "8 dos 16 promovidos fecharam a 3 pontos ou menos da linha do G4, e no total 28 de 80 clube-temporadas (35%) estão colados numa das duas linhas — 50% entre os que sobem, 33% no meio, 25% entre os que caem. A Trave (5º a 8º) fechou entre 56 e 64 pontos, mediana 60,5, ou seja 2,5 pontos abaixo do corte do G4, e 9 dos 16 casos ficaram a 3 pontos ou menos dele. Refazendo a mesma contagem pela tabela remontada jogo a jogo em vez da oficial, todos esses números se repetem e só o piso da Trave muda, de 56 para 55; nenhum teste aqui diz se a Trave joga diferente de quem sobe, e por isso vale como indício.",
   ...
   "conclusoes": [
    {
     ...
     "parte": "A02",
     "bloco": "A",
     "manchete": "Quem sobe finaliza de mais perto, e isso vem antes dos pontos",
     "o_que_vimos": "Quem sobe finaliza a 19,5 m do gol e o meio a 20,5 m — quase um metro mais perto em cada chute, com os 20 times de cada ano; tirando os que estavam colados na linha é a mesma coisa, 19.669 contra 20.522. Volume não separa em corte nenhum, dos dois lados: 12,6 finalizações por jogo contra 12,3 do meio, e 11,6 sofridas contra 12,1 — diferenças que este número de times não conseguiria enxergar. E o time que já finalizava de perto nas 19 primeiras rodadas fez mais pontos nas 19 seguintes, mesmo comparado com quem vinha pontuando igual (80 clube-temporadas).",
    ...
    },
    {
     ...
     "parte": "A02",
     "bloco": "A",
     "manchete": "Quem sobe não sofre menos finalização, sofre finalização pior",
     "o_que_vimos": "Quem sobe sofre 11,6 finalizações por jogo e o meio 12,1: praticamente o mesmo, e esse empate vale nos dois cortes. O que muda é o tamanho da chance — a cada 100 finalizações que cede, quem sobe leva 8,9 gols esperados e o meio 9,8, com os 20 times de cada ano, e a diferença fica maior ainda sem os que estavam colados na linha. O xG que cede por jogo anda no mesmo sentido (1,02 contra 1,18), mas esse só fica claro quando se tiram os colados na linha (1.002 contra 1.189), e pode ser efeito do placar: quem está ganhando recua e passa a ceder chute de longe.",
    ...
    },
    {
     ...
     "parte": "A02",
     "bloco": "A",
     "manchete": "Quem sobe faz mais gol do que a chance pedia — e essa sobra não se compra",
     "o_que_vimos": "Com os 20 times de cada ano, quem sobe faz 0,05 gol por jogo a mais do que as chances pediam e o meio fica 0,17 abaixo — cerca de 8 gols numa temporada inteira, a maior diferença da lista e a única que separa quem sobe dos times de 5º a 8º, nos dois cortes. Tirando os times colados na linha, quem sobe também fica abaixo do que as chances pediam (-0.052) e mesmo assim continua à frente do meio: a vantagem aparece nos dois cortes, o nível dela não. Do lado do goleiro não há nada em corte nenhum (0,2 gol por jogo a menos do que as chances pediam contra 0,17 do meio), e a sobra de uma metade do ano quase não tem relação com a da outra — mas essa régua é quase toda ruído, então o estudo não tem prova de que ela se repita, o que não é prova de que ela não se repete.",
   ...
   "conclusoes": [
    {
     ...
     "o_que_vimos": "Em toda a Série B, jogar em casa vale 0,79 ponto por jogo a mais do que jogar fora, e fora do placar as faixas ficam perto: de quem sobe para o meio, 0,42 contra 0,39 de xG criado, 0,45 contra 0,39 de xG sofrido e 0,89 contra 1,16 ponto percentual de dividida. A exceção está só no placar e só num dos dois cortes: o grupo de 5º a 8º fica em 0,87 ponto por jogo com todos os times, colado nos 0,9 de quem sobe, e salta para 1,47 quando se tiram os times colados na linha — corte que deixa 7 dos 16 clube-temporadas do grupo, e ali a mediana é quase o valor de um clube só. Nenhum dos 24 testes de casa menos fora viu diferença entre as faixas, e nenhum tinha amostra para ver: este desenho só enxergaria diferenças grandes, e ninguém checou se depender de casa vem antes ou depois do resultado.",
    ...
    },
    {
     ...
     "parte": "A03",
     "bloco": "A",
     "manchete": "Quem sobe ganha mais dividida dentro e fora, mas só sofre menos perigo em casa",
     "o_que_vimos": "Contra o meio, quem sobe ganha 60,9% das divididas defensivas em casa, contra 60,1%, e 60,6% fora, contra 59,6%: a vantagem aparece nos dois mandos com os 16 promovidos contra 48 do meio, e continua, maior, nos 8 contra 32 que sobram sem os times colados na linha. Em casa, quem sobe cede 0,8 de xG por jogo contra 1,02 do meio, também nos dois cortes; fora a distância encolhe para 1,29 contra 1,36 e o teste não a enxerga. O xG sofrido fora só passa no corte reduzido, justamente o que o método da casa trata como enviesado, e por isso fica fora da manchete — e o que se vê fora pode ser efeito do placar, porque quem visita passa mais tempo atrás.",
    ...
    },
    {
     ...
     "o_que_vimos": "Em casa, quem cai cria 1,26 de xG por jogo contra 1,39 do meio; fora, sofre 1,56 contra 1,36, com 16 do Cai contra 48 do Meio. As duas se repetem sem os times colados na linha, com 12 contra 32, e lá a distância de fora é até maior: 1,65 contra 1,39. Mas quem cai é pior nos quatro números, e o xG sofrido fora pode ser efeito do placar: time que cai passa mais tempo atrás do marcador longe de casa.",
   ...
   "conclusoes": [
    {
     ...
     "parte": "A04",
     "bloco": "A",
     "manchete": "Bola parada não é o que faz subir: nada do trabalho separa quem sobe do meio, e o que separa é gol — que já é o placar",
     "o_que_vimos": "Os 8 sinais de trabalho de bola parada — bolas paradas e escanteios por jogo, finalizações de escanteio, finalizações de falta, conversão, cruzamentos, duelo aéreo e altura do elenco — não separam os 16 que sobem dos 48 do meio, e seguem sem separar quando se tiram os times colados na linha, 8 contra 32. O que aparece é gol: quem sobe fecha a temporada com 5,5 gols de bola parada a mais do que sofre e o meio fecha empatado, o mesmo vão nos dois cortes — só que gol é o placar contado de outro jeito, e com 8 contra 32 essa vantagem deixa de sobrar na conta que desconta o número de comparações feitas. Com este tamanho de amostra só uma diferença muito grande apareceria: “não separa” aqui quer dizer “este desenho não conseguiria ver”.",
    ...
    },
    {
     ...
     "parte": "A04",
     "bloco": "A",
     "manchete": "Um em cada três gols da Série B sai de bola parada — e não achamos faixa que dependa mais dela",
     "o_que_vimos": "Na liga, 34,02% dos gols de um time vêm de bola parada: 0,37 gol por jogo, cerca de 14 gols numa temporada inteira. A mediana fica perto disso em todas as faixas — 35,19% dos 16 que sobem, 34,02% dos 48 do meio e 31,37% dos 16 que caem, com a trave em 33,16%, que são 16 times de dentro do próprio meio e não uma quarta faixa —, e nenhuma dessas diferenças se sustenta, nem com todos os times nem tirando os colados na linha. Entre clubes a variação é enorme, de 16,3% a 60,7%, com metade entre 27,2% e 39,5% — e este desenho só enxergaria uma diferença muito grande entre faixas: “não separa” significa “este desenho não conseguiria ver”.",
    ...
    },
    {
     ...
     "parte": "A04",
     "bloco": "A",
     "manchete": "Quem cai perde no alto: o duelo aéreo é a única coisa desta parte que separa quem desce",
     "o_que_vimos": "Quem cai fica com 44,3% de duelos aéreos ganhos contra 46,1% do meio — 1,8 ponto a menos, nos 16 rebaixados contra os 48 do meio; tirando os times colados na linha, 12 contra 32, a distância é ainda maior, 43,5% contra 46,5%. No gol, quem cai faz 0,28 gol de bola parada por jogo contra 0,34 do meio e sofre 0,45 contra 0,36, saldo de -0,13 contra 0 — mas perde gol de bola parada na mesma proporção em que perde gol de qualquer origem, então é o placar contado de outro jeito, não um traço de bola parada. O trabalho não muda de faixa para faixa: quem cai cobra 5,0 escanteios por jogo contra 5,1 do meio, e a fatia dos seus gols que vem de bola parada é a mesma das outras faixas, nos dois cortes.",
   ...
   "conclusoes": [
    {
     ...
     "parte": "A05",
     "bloco": "A",
     "manchete": "Nenhum jeito de construir separa quem sobe — nem ter a bola, que só aparece quando se tiram os times colados na linha",
     "o_que_vimos": "Dos 10 traços com bola medidos, nenhum separa quem sobe do meio com os 20 times do ano na conta: quem subiu teve 51,4% da bola contra 49,8% do meio e deu 21 passes a mais por jogo. Tirando os times que terminaram a até 3 pontos da linha, ter a bola passa a separar — 51,7% contra 50,2%, 8 promovidos contra 32 do meio — e só nesse corte. Quem já tinha mais a bola nas 19 primeiras rodadas somou mais pontos nas 19 seguintes, mesmo entre times que vinham com a mesma pontuação.",
    ...
    },
    {
     ...
     "parte": "A05",
     "bloco": "A",
     "manchete": "Dá para subir com menos da metade da bola — mas quem fez isso subiu raspando",
     "o_que_vimos": "4 dos 16 promovidos ficaram com menos da metade da bola — Chapecoense, Remo, Criciúma e Ceará, a menor delas com 47,4% — e os quatro terminaram a 1 ponto ou menos do 5º colocado. Os 8 que subiram com folga tiveram todos mais da metade da bola, de 50,1% do Grêmio a 61,6% do Cruzeiro. São 4 casos contados, não um teste, e posse muda com o placar: quem está ganhando cede a bola, e a base não permite separar por estado do jogo.",
   ...
   "conclusoes": [
    {
     ...
     "parte": "A06",
     "bloco": "A",
     "manchete": "Quem sobe ganha mais a dividida no chão — sobre pressão alta o estudo não decide",
     "o_que_vimos": "Com todos os times na conta, quem sobe ganha 60,77% das divididas no chão contra 59,78% do meio — cerca de uma dividida a mais ganha a cada cem disputadas — e sem os times colados na linha a vantagem vai a 61,67% contra 59,89%. Sobre pressão alta o estudo não decide: quem sobe deixa o adversário dar 9,69 passes por ação defensiva contra 10,13 do meio (9,46 contra 10,26 sem os colados na linha), recuperações (78,38 contra 77,92 por jogo) e intensidade (15,69 contra 15,55) ficam empatadas, e diferenças desse tamanho um estudo de 16 promovidos não enxerga — se apontam para algum lado, é para quem sobe pressionar mais, não menos. Pode ser efeito do placar: pressão e intensidade mudam conforme o time está ganhando ou perdendo e a base não permite separar isso; e elenco caro tende a pressionar alto, coisa que o estudo também não separa da pressão em si.",
    ...
    },
    {
     ...
     "parte": "A06",
     "bloco": "A",
     "manchete": "Entre subir e parar entre 5º e 8º, o jogo sem bola não mostra degrau — a dividida no chão só separa quando se tiram os times colados na linha",
     "o_que_vimos": "Sem os times colados na linha, quem sobe ganha 61,67% das divididas no chão contra 59,79% de quem parou entre 5º e 8º; com todos os times na conta a diferença encolhe para 60,77% contra 59,81% e o estudo não decide. Esse corte tira 9 dos 16 times da trave, e justamente os mais fortes (mediana de 63 pontos nos que saem contra 57 nos que ficam), enquanto do lado de quem sobe tira os mais fracos — compara um grupo reforçado com um enfraquecido — e ainda sobram 8 times contra 7, tamanho em que só uma diferença enorme apareceria. Com todos os times na conta, o único indicador sem bola que separa as duas faixas é o duelo aéreo, e para o outro lado: quem sobe ganha 45,54% dos duelos aéreos contra 47,60% da trave.",
    ...
    },
    {
     ...
     "parte": "A06",
     "bloco": "A",
     "manchete": "Quem sobe sofre tanto chute quanto o meio — o que muda é o tamanho da chance que ele entrega",
     "o_que_vimos": "Quem sobe sofre menos finalização por jogo (11,62 contra 12,05 do meio), mas isso é a posse: pondo a posse do adversário na mesma base — finalizações sofridas por 50% de posse do adversário — o volume empata e nem escolhe lado, 12,52 contra 12,23 com todos os times e 12,26 contra 12,38 sem os colados na linha. O que fica é o tamanho da chance cedida: cada finalização que quem sobe sofre vale 0,089 gol esperado contra 0,098 do meio, cerca de um gol esperado a menos a cada cem chutes sofridos, e sem os colados na linha 0,086 contra 0,100. É o mesmo número que o A02 já publica, não uma segunda prova, e o gol esperado é régua curta — reproduz só 0,36 de si mesmo entre rodadas pares e ímpares —, então a diferença conta pela direção, não pelo tamanho.",
   ...
   "conclusoes": [
    {
     ...
     "parte": "A07",
     "bloco": "A",
     "manchete": "Corrida não separou quem sobe do meio — e só uma diferença enorme apareceria neste estudo",
     "o_que_vimos": "O time mediano de quem subiu percorreu 9.644 metros por jogo contra 9.598 do meio, e 669 em alta intensidade contra 652 — no ranking de corrida do próprio ano, 1 posição de diferença; sem os times que ficaram a três pontos da linha, 9.631 contra 9.597 e 666 contra 652. Nenhum dos 12 indicadores físicos declarados separou quem sobe nos dois cortes, nem depois de tirar os 20 clube-temporada com menos jogo rastreado, nem depois de descontar o tamanho do rodízio de elenco. Este desenho só enxergaria a partir de 4,7 posições de diferença, quase um quarto da tabela: não vimos diferença, o que não é o mesmo que não haver — e correr muda com o placar, recorte que esta base não permite.",
    ...
    },
    {
     ...
     "parte": "A07",
     "bloco": "A",
     "manchete": "Quem cai sprinta menos nos minutos sem a bola, e não é só por rodar mais o elenco",
     "o_que_vimos": "A cada 30 minutos sem a bola, o time mediano dos rebaixados correu 91,1 metros em sprint contra 100,0 do meio — sem os times que ficaram a três pontos da linha, 91,1 contra 100,9; no ranking do próprio ano, 4,5 posições abaixo. Com a bola o buraco bruto vai na mesma direção (89,4 contra 99,1 metros), mas varia tanto de time para time que esta amostra não separa as duas fases: o estudo não consegue dizer onde exatamente falta o sprint. Descontado o rodízio — quem cai usou 25,5 atletas rastreados na temporada contra 21 do meio —, o sprint sem a bola é o único número físico que continua de pé nos dois cortes; o sprint somado no jogo inteiro e a velocidade máxima deixam de separar, e todos eles são média de cerca de 15 jogos por atleta, não de 38.",
   ...
   "conclusoes": [
    {
     ...
     "parte": "A10",
     "bloco": "A",
     "manchete": "A perna não decidiu o acesso: no returno quem subiu perdeu os mesmos 100 metros por jogo que o meio",
     "o_que_vimos": "Do 1º para o 2º turno o mesmo jogador perde 74 metros por 90 na média e 98 pela mediana — 0,8% do que ele já corria —, e a perda é real: contando clube a clube, quem subiu perde de 43 a 152 metros, enquanto na liga inteira o intervalo ainda encosta no zero, de −157 a +7 metros. Só que ela é igual para todo mundo: 101 metros no Sobe contra 71 no meio pela média, 100 contra 101 pela mediana, e alta intensidade, sprints e velocidade de pico ficam onde estavam. Das 96 comparações físicas entre quem subiu e o meio nenhuma passou no critério, nos dois cortes de fronteira — o que separou as duas faixas foi ponto no 2º turno, 1,71 por jogo contra 1,34, e mesmo esse número tem um corte só, porque sem os times da fronteira sobram 2 clubes no Sobe e a conta não roda.",
    ...
    },
    {
     ...
     "parte": "A10",
     "bloco": "A",
     "manchete": "Quem caiu em 2025 corre menos forte que o meio desde o 1º turno — não é cansaço de returno, é elenco",
     "o_que_vimos": "No 2º turno os rebaixados dão 7,4 sprints por 90 contra 8,8 do meio, e 7,3 contra 9,1 quando se tiram os times a três pontos da linha — a única medida que passa no critério nos dois cortes. Mas o buraco não começa no returno: já no 1º turno o rebaixado corre 618 metros em alta intensidade por 90 contra 690 do meio, e essa diferença passa nos dois cortes quando cada jogador é comparado dentro do próprio setor (na conta sem setor, o 1º turno não passa em corte nenhum). Não é cansaço: dentro do mesmo jogador o rebaixado até sprinta um pouco mais no returno (+0,1 sprint por 90), e o que muda é quem está em campo — quem caiu usou 35,9 atletas diferentes por meio de temporada contra 29,1 de quem subiu.",
   ...
   "conclusoes": [
    {
     ...
     "o_que_vimos": "Correr mais com a bola não muda nada: o terço que mais percorre metros faz 21,9 entradas na área por jogo contra 21,6 do terço que menos percorre, e os dois criam o mesmo 1,19 de xG por jogo. Já o terço que mais corre para dentro da área — 3,6 corridas a cada 30 minutos com a bola, contra 2,5 — faz 23,4 entradas na área por jogo contra 20,4 e cria 1,28 de xG contra 1,11, e 23 desses 28 times estão na metade de cima em entradas na área, contra 8 do outro terço. A mesma relação aparece igual sem os 28 times colados nas linhas de acesso e de rebaixamento (52 times) e fica mais forte quando se tiram os 20 de cobertura física mais baixa (60 times).",
    ...
    },
    {
     ...
     "parte": "A11",
     "bloco": "A",
     "manchete": "Correr sem a bola sobe a linha de pressão — em bola recuperada não aparece",
     "o_que_vimos": "O terço que mais corre sem a bola — 113 metros de sprint a cada 30 minutos sem posse, contra 87 — deixa o adversário dar 9,3 passes por ação defensiva, contra 11,2 do terço que menos corre, e essa pressão mais alta se repete inteira sem os times colados nas linhas de acesso e de rebaixamento (52 times). Em bola recuperada os dois terços empatam — 77,9 contra 77,6 por jogo, diferença menor que o ruído do dado, nos dois cortes — e a pequena vantagem no xG sofrido do terço que mais corre (1,13 contra 1,24 por jogo) desaparece quando se tiram esses mesmos times. E isso é “não achamos”, não “não tem”: com estes 80 times o teste só enxergaria uma relação de tamanho médio para cima.",
    ...
    },
    {
     ...
     "o_que_vimos": "Entre os times de nível técnico alto, quem subiu percorreu 9.614 metros por jogo e quem ficou no meio, 9.620 — diferença de -6 metros em quase dez quilômetros; na faixa do meio são 25 metros a favor de quem subiu, nenhuma das 10 comparações apareceu, e tirando os times colados nas linhas sobra só a faixa alta para comparar, 7 contra 9, onde também não aparece. Do outro lado, correr anda com a tabela — o terço que mais sprinta somou 54,5 pontos contra 47,9 do que menos sprinta —, mas a diferença inteira está embaixo: os dois terços puseram os mesmos 5 times no G4, em 28 cada, e o que menos corre teve 9 rebaixados contra 2. E isso apesar de correr ser o traço mais repetido que a Protótipo mediu ano a ano, com só o valor do elenco se repetindo tanto quanto: no ranking de corrida um clube muda em média 3,5 posições de uma temporada para a outra, contra 6,1 no de xG criado e 6,1 no de pressão.",
   ...
   "conclusoes": [
    {
     ...
     "parte": "A12",
     "bloco": "A",
     "manchete": "O que o clube escolhe e separa quem sobe é a chance: chutar de perto e obrigar o adversário a chutar mal — o resto é dinheiro e efeito de estar ganhando",
     "o_que_vimos": "Quem sobe finaliza de 19,5 metros e o meio de 20,5 — a única diferença de jogo que aparece com e sem os times que terminaram colados na linha e que ainda se vê antes do resultado. Quem sobe também obriga o adversário a chutar pior, 0,089 de gol esperado por finalização sofrida contra 0,098 do meio, com a ressalva de que o gol esperado é a medida menos confiável da casa; as outras duas diferenças não são escolha, porque o elenco de quem sobe vale 24,0 milhões de euros contra 13,9 do meio e os onze mais usados ficam com 68,1% dos minutos contra 63,1%. Ter a bola só separa quando se tiram os times colados na linha (51,7% contra 50,2%, e 51,4% contra 49,8% com eles dentro); pressão, corrida e bola aérea não separam em corte nenhum; e a explosão só aparece do outro lado da tabela — quem cai corre 156 metros em sprint por jogo contra 168 do meio, nos dois cortes.",
    ...
    },
    {
     ...
     "parte": "A12",
     "bloco": "A",
     "manchete": "O jeito de jogar dos que subiram sem dinheiro não é atalho: quem jogou assim caiu mais do que subiu",
     "o_que_vimos": "Entre 2022 e 2025, 22 dos 80 times jogaram dentro da faixa do Cenário Barato — pressão baixa, posse perto da metade, bola direta — e o saldo foi 4 acessos contra 7 rebaixamentos, num campeonato em que sobem 16 e caem 16 a cada quatro anos. Dos 4 que subiram jogando assim, dois eram o elenco mais caro e o terceiro mais caro do ano, então a faixa não é dos pobres; olhando só quem não tem dinheiro, subiram 2 dos 13 que jogaram assim contra 4 dos 48 sem dinheiro em geral, e essa é a única maneira de contar em que a faixa parece ajudar. Em 2026, na 27ª rodada de 38, 5 times sem dinheiro jogam dentro da faixa: o melhor é o 6º, último lugar da zona de acesso, o 7º tem os mesmos 43 pontos, o 8º está a um ponto e os outros dois são 14º e 15º.",
    ...
    },
    {
     ...
     "parte": "A12",
     "bloco": "A",
     "manchete": "O perfil do time barato, do jeito que está escrito, deixa de fora dois dos quatro times de que foi tirado",
     "o_que_vimos": "A faixa publicada é pressão de 10,0 a 13,2, posse de 47% a 52% e bola longa de 10% a 14%, tudo em número redondo. Cobrada assim, o Vitória de 2023 fica fora por 52,0153% de posse e a Chapecoense de 2025 por 14,0858% de bola longa — dois dos quatro casos. E, olhando o lugar de cada um dentro do próprio ano, os quatro só se parecem na pressão: em posse eles vão do 5º ao 17º da liga, e em bola longa do 3º ao 19º.",
   ...
   "conclusoes": [
    {
     ...
     "parte": "A13",
     "bloco": "A",
     "manchete": "Quem cai chega à metade do campeonato 5,5 pontos atrás do meio da tabela",
     "o_que_vimos": "No 1º turno, quem terminou rebaixado fez 19,5 pontos de mediana contra 25 do meio da tabela, e 15 dos 16 rebaixados ficaram abaixo dessa marca; tirando os times que terminaram colados nas linhas de corte sobram 52 campanhas e a distância se mantém — 19 contra 24, com 11 dos 12. O tombo do returno não aparece: 6 dos 16 rebaixados fizeram mais pontos no 2º turno do que no 1º (4 dos 12 no corte sem os colados nas linhas), e a diferença entre as faixas no returno é menor do que este desenho consegue enxergar. Quem piora no returno depende de quais times entram na conta — com as 80 campanhas quem subiu melhora 1,0 ponto, sem os colados nas linhas perde 2,0 —, e como isso é contagem sem teste e os pontos do 1º turno já entram na soma que define a faixa, fica como indício.",
    ...
    },
    {
     ...
     "parte": "A13",
     "bloco": "A",
     "manchete": "Na metade, a tabela já tem 10 dos 16 acessos e 10 dos 16 rebaixamentos — o resto virou depois",
     "o_que_vimos": "Na rodada 19, 10 dos 16 times que subiram já estavam no G4 e 10 dos 16 que caíram já estavam no Z4. O resto virou depois: 6 subiram vindo de fora do G4, 6 escaparam do Z4, 6 caíram vindo de fora dele e 6 perderam o G4 que já tinham. Tirando os times que terminaram colados nas linhas de corte sobram 52 campanhas e as viradas encolhem — 1 acesso vindo de fora, 4 fugas do Z4, 4 quedas vindas de fora e nenhuma perda de G4 —, porque esse corte tira justamente quem terminou por pouco; é contagem de 4 temporadas, sem teste, e mede onde o time estava, não o que veio depois.",
    ...
    },
    {
     ...
     "parte": "A13",
     "bloco": "A",
     "manchete": "A tabela da metade dá vantagem, não garante a segunda metade",
     "o_que_vimos": "O terço que mais pontuou no 1º turno fez 31 pontos no returno e o terço que menos pontuou fez 22 — 9 pontos de diferença em 19 jogos, e 6 pontos nas 52 campanhas sem os times colados nas linhas de corte. E as campanhas se cruzam: o melhor returno entre os times do terço de baixo (37 pontos, o Ituano de 2022) foi maior que o de qualquer time do terço de cima (36, o Cruzeiro de 2022), nos dois cortes. O que a tabela da metade mostra em primeiro lugar são os pontos já ganhos, que já estão somados na classificação final.",
   ...
   "conclusoes": [
    {
     ...
     "parte": "A14",
     "bloco": "A",
     "manchete": "A régua do Bloco A cabe em 7 indicadores, e quem subiu aparece no alto dela",
     "o_que_vimos": "A régua junta 7 coisas que separaram quem sobe do meio nas duas contagens de fronteira e não são o resultado contado de outro jeito: finalizar de perto, criar chance boa, ceder chance ruim, ganhar o duelo defensivo, sofrer pouco em casa, ganhar o duelo em casa e o valor do elenco. Dos 16 times que subiram de 2022 a 2025, 11 estavam entre os quatro primeiros da régua na própria temporada e 9 ficaram acima de todo o meio da tabela; tirando os times colados na linha do G4 e do Z4 sobram 8 promovidos, e 7 deles ficam acima de todo o meio — sem esses times a régua fica mais nítida, não menos. A trave (5º–8º) parecia um degrau próprio, mas 9 das suas 16 temporadas são de times colados na linha: tirando-os ela encosta no meio, é um recorte do meio e não uma quarta faixa.",
    ...
    },
    {
     ...
     "parte": "A14",
     "bloco": "A",
     "manchete": "Em duas das quatro temporadas não dá para saber se a régua vale — e quais duas muda conforme quem entra na conta",
     "o_que_vimos": "Temporada a temporada — e nenhuma foi deixada de fora, ao contrário do que este texto dizia antes: a régua pôs 3 dos quatro promovidos entre os seus quatro primeiros em 2022, 2 em 2023, 4 em 2024 e 2 em 2025. Com quatro promovidos contra doze do meio, o ano isolado é pequeno demais para responder: em 2.023 e 2.025 a diferença fica abaixo do que esse tamanho de amostra conseguiria enxergar, o que não é o mesmo que não existir. E a metade fraca troca de lado quando se tiram os times colados na linha do G4 e do Z4: 2.025 vira o ano mais nítido dos quatro, enquanto 2.023 e 2.024 — este chamado de forte aqui — ficam com um promovido só e sem comparação possível.",
    ...
    },
    {
     ...
     "parte": "A14",
     "bloco": "A",
     "manchete": "Em 2026 a régua põe no topo os dois primeiros da tabela — coisa que só aconteceu em 1 das quatro temporadas fechadas",
     "o_que_vimos": "Na rodada 27, os dois primeiros da régua são Novorizontino e Juventude — os mesmos dois que lideram a tabela, mas em ordem trocada. Nas quatro temporadas fechadas isso só aconteceu uma vez, em 2.025, e no resto da tabela de 2026 a régua erra feio: o Vila Nova é 3º em pontos e só 12º na régua. Ela também não separa o 1º–2º do 3º–6º — a diferença que aparecia some quando se tiram os times colados na linha do G4, e não é acaso: 12 das 16 temporadas do grupo 3º–6º são justamente times colados nela, contra 2 das 8 do 1º–2º.",
   ...
   "conclusoes": [
    {
     ...
     "parte": "T01",
     "bloco": "T",
     "manchete": "Time da Série B troca de treinador uma vez por ano, e só 40 dos 160 times de 2018 a 2025 terminaram o ano com quem começaram",
     "o_que_vimos": "Nas 160 clube-temporadas fechadas de 2018 a 2025 a mediana é de 2 treinadores efetivos e a média é de 1,3 troca por ano — uma troca, não duas —, e só 40 times, um em cada quatro, terminaram o ano com o treinador que o abriu. 2026 fica fora da conta por temporada porque não acabou: com 26 ou 27 das 38 rodadas jogadas, 10 dos 20 times ainda estão com o primeiro treinador, contra 20% a 35% em cada ano fechado, e é essa temporada pela metade que inflava o número antigo para 3 em cada 10 (juntando os 9 anos dá 49 de 180, 27%). Os interinos dirigiram 283 das 6.546 rodadas com treinador identificado; é contagem de uma fonte só, sem nenhum teste por trás, e por isso entra como indício.",
    ...
    },
    {
     ...
     "parte": "T01",
     "bloco": "T",
     "manchete": "Treinador de Série B roda entre clubes: 29 comandaram dez rodadas ou mais em três clubes ou mais — e só 14 deles de 2022 para cá",
     "o_que_vimos": "Dos 193 treinadores da base, 29 tiveram passagem de dez rodadas ou mais em três clubes ou mais da Série B: Allan Aal em 9, Claudinei Oliveira, Marcelo Cabo e Mozart em 7 cada, Daniel Paulista e Guto Ferreira em 6. Dentro de 2022 a 2025, que é a janela em que T03 tem régua técnica e física, restam 14 — 15 se 2026 entrar —, ou seja, metade da lista larga. É contagem de uma fonte só, sem teste por trás, e por isso entra como indício; e o 29 é piso, porque 62 das 6.608 rodadas jogadas ficaram sem treinador conhecido e qualquer uma delas só pode somar clubes.",
    ...
    },
    {
     ...
     "parte": "T01",
     "bloco": "T",
     "manchete": "O nome do treinador deixou de ser o que não dá, e uma segunda fonte confirma a coleta",
     "o_que_vimos": "A etapa 15 da Protótipo dizia que não havia nome de treinador em base nenhuma e estimava de 250 a 400 passagens para 100 clube-temporadas; a coleta entregou 276 nessa mesma janela, e 492 em 180 clube-temporadas de 9 temporadas. A conferência contra uma segunda fonte, que a parte dava como não feita, existe e passa: das 157 passagens de dez jogos ou mais do Sofascore que já estavam em casa desde 14/09, 150 batem com a coleta no mesmo clube e no mesmo ano. Das 7 que não batem, 5 são apelido do mesmo homem — Marcinho é Márcio Freitas no Ituano de 2023, com as mesmas 30 rodadas dos dois lados — e 2 são treinadores que a coleta não tem, os dois dentro dos 29 clube-temporadas com buraco; é contagem, não teste, e por isso entra como indício.",
   ...
   "conclusoes": [
    {
     ...
     "parte": "T02",
     "bloco": "T",
     "manchete": "No G4 o que pesa é o preço do elenco",
     "o_que_vimos": "Clube com elenco entre os 5 mais caros do ano passa, em média, 14,6 das 38 rodadas no G4; do 6º ao 10º elenco, 9,5; do 11º para baixo, 3,2 — e 22 dos 40 clubes desse último grupo não passam uma rodada sequer lá. Contando só da 10ª rodada em diante, como a régua da casa também manda, a escada é a mesma e fica mais forte: 11,7 · 7,1 · 2,3 rodadas em 29. Nos dois jeitos de contar a distância que a conta sustenta é a dos 5 mais caros contra o 11º para baixo; entre os 5 mais caros e o 6º-10º a diferença não se separa do acaso em nenhum dos dois.",
    ...
    },
    {
     ...
     "parte": "T02",
     "bloco": "T",
     "manchete": "No pior ano de Eduardo Baptista o time ainda passou mais de um terço das rodadas no G4 — é o piso mais alto de quem trocou de clube",
     "o_que_vimos": "Nas 3 passagens de 2022 a 2025, em 2 clubes, a pior teve o time 12 rodadas no G4 em 32 e a melhor, 20 em 38 — é o piso mais alto entre os 28 treinadores que passaram por dois clubes ou mais, e o segundo, Jair Ventura, ficou em 5 rodadas em 27. O piso dele é o mais alto nos quatro jeitos de contar: da 10ª rodada em diante são 12 rodadas em 29 contra 2 em 18 do segundo, e mesmo incluindo 2026, que fica de fora por estar em curso, o segundo passa a ser Thiago Carpini com 10 rodadas em 32. Dois desses três anos são no Novorizontino, com o 10º e o 16º elencos mais caros do ano e 1,67 ponto por jogo; o terceiro é o Criciúma de 2025, que tinha o 8º elenco — esse não é clube sem dinheiro.",
    ...
    },
    {
     ...
     "o_que_vimos": "Dos 28 treinadores que passaram por dois clubes ou mais entre 2022 e 2025, 7 têm um ano sem uma rodada sequer no G4 e outro com o time lá em mais de 8 de cada 10 rodadas: Claudinei Oliveira, Enderson Moreira, Guto Ferreira, Jorginho, Léo Condé, Mozart e Vagner Mancini. E o ano bom quase não foi melhor no placar: nesses 7 o ano de mais tempo no G4 rendeu 0,12 ponto por jogo a mais que o ano zerado, e em 3 deles rendeu o mesmo ou menos — contando só da 10ª rodada em diante, como a régua da casa também manda, são 8 nomes, 0,26 ponto por jogo e 2 casos iguais ou piores. Fica como indício, e não como prova de que nada se transfere: com 28 nomes só uma ligação forte apareceria neste desenho, e a que aparece do primeiro clube para o seguinte é fraca.",
   ...
   "conclusoes": [
    {
     ...
     "parte": "T03",
     "bloco": "T",
     "manchete": "Do treinador só viaja de onde o time chuta; o resto não fica com ninguém",
     "o_que_vimos": "Comparei cada treinador consigo mesmo quando trocou de clube, em sete traços do jeito de jogar, nas 126 passagens de 10 rodadas ou mais de 2022 a 2025: 4 dos 28 que comandaram dois clubes levaram o mesmo jeito de jogar de um para o outro, e o acaso previa 1,27 — com a temporada em andamento dentro da conta a leitura é a mesma, 5 de 34 contra 1,68. De sete traços, só um acompanha o treinador com regularidade: em 6 de cada 10 comparações entre dois clubes do mesmo treinador a distância de onde o time chuta cai do mesmo lado do meio da tabela, contra 4,7 em cada 10 pelo acaso — e no mesmo clube, com treinadores diferentes, a semelhança do jeito de jogar é a metade da que o treinador carrega. O sinal é fino e a régua é curta: a mesma passagem, cortada em jogos pares e ímpares, já concorda consigo mesma em só 3,7 dos 7 traços.",
    ...
    },
    {
     ...
     "parte": "T03",
     "bloco": "T",
     "manchete": "Trocar treinador não compra jeito de jogar novo, e os pontos que vêm depois são o time voltando ao normal",
     "o_que_vimos": "Em 66 trocas de treinador de 2022 a 2025, com pelo menos 8 jogos antes e 8 depois no mesmo clube e na mesma temporada, nenhum dos sete traços do jeito de jogar puxa o time para um lado só: no traço em que mais trocas concordam são 36 das 66, e nos outros é menos. Cada time anda bastante — de 4 a 7,5 posições entre os 20 do campeonato, conforme o traço —, mas a mesma passagem de um treinador só, cortada ao meio, anda o mesmo tanto: é janela curta oscilando, e não a chegada do treinador. Com a temporada em andamento dentro da conta a leitura não muda (73 trocas, a mesma ausência de direção comum), e este desenho só enxergaria um movimento comum de 2,4 a 3,5 posições — abaixo disso ele não responde.",
   ...
   "conclusoes": [
    {
     ...
     "parte": "T04",
     "bloco": "T",
     "manchete": "O nome que a lista apontava nunca subiu — e os dois que subiram com dois clubes diferentes nem entraram nela",
     "o_que_vimos": "Nas quatro temporadas fechadas, 30 treinadores chegam a 30 rodadas ou mais; pela pior passagem os dois primeiros são campeões de uma temporada só — 89,5% e 89,2% das rodadas no G4, com o 3º e o 1º elenco mais caro do ano — e o terceiro é Eduardo Baptista, 37,5% na pior de 3 passagens em 2 clubes. Trocar a pior passagem pela média, que a mesma conta já produz, muda a lista: Enderson Moreira passa à frente com 48,5% em 5 clubes contra 47,2% dele; e contar só a partir da 10ª rodada muda de novo, com ele em 1º de 22 e 41,4%, porque aí os dois de cima não alcançam as 30 rodadas. A pior passagem zera para 21 dos 30, inclusive para os 9 que comandaram quatro vezes ou mais, e nenhuma das contas mexe no resultado: ele terminou em 5º nas três temporadas, duas a um ponto do 4º colocado e uma empatada em pontos com ele, enquanto Léo Condé (Vitória 2023 e Ceará 2024) e Mozart (Mirassol 2024 e Coritiba 2025) subiram com dois clubes cada e ficaram de fora da lista por terem uma passagem zerada.",
    ...
    },
    {
     ...
     "parte": "T04",
     "bloco": "T",
     "manchete": "O histórico do treinador não reaparece no clube seguinte — e esta base não conseguiria ver se reaparecesse",
     "o_que_vimos": "Entre os 28 treinadores que passaram por dois clubes ou mais nas temporadas fechadas, a diferença típica entre a melhor e a pior passagem é de 21,7 pontos percentuais do tempo no G4, e 8 deles variam mais de 50: uma passagem quase sempre no G4 e outra quase nunca. O jeito de jogar também não acompanha o treinador de um clube para outro, em 126 passagens de 64 nomes, e o time não muda nas 66 trocas no meio da temporada com pelo menos 8 jogos de cada lado — com a base inteira, 2026 incluído, são 34 multiclube, 16,2 pontos percentuais típicos, 9 acima de 50, 151 passagens, 69 nomes e 73 trocas, e a leitura é a mesma. Mas o desenho é pequeno demais para fechar a conta: ele não enxergaria nem a repetição que ele próprio mediu, e 3 dos 7 traços do perfil são medidos com régua curta demais para mostrar repetição ainda que ela existisse — por isso é falta de prova de que o treinador se repete, e não prova de que ele não se repete.",
   ...
   "conclusoes": [
    {
     ...
     "parte": "J01",
     "bloco": "J",
     "manchete": "Com um corte único de minutagem, sobra goleiro e falta atacante: passam 27,3% dos goleiros e 7% dos atacantes",
     "o_que_vimos": "Em 3.160 jogador-temporadas de 2022 a 2025, o corte de 60% dos minutos do time deixa passar 27,3% dos goleiros, 22,5% dos zagueiros, 7,8% dos extremos e 7% dos atacantes, e o goleiro mediano joga 21,7% dos minutos do time contra 16,5% do atacante mediano. Com esse corte, quatro temporadas inteiras de Série B devolvem 8 atacantes e 7 extremos de minutagem alta e repetida, contra 16 goleiros e 20 zagueiros; medindo “alta” dentro da própria posição, a mesma regra devolve 215 nomes no lugar de 90. O vão aparece nas quatro temporadas uma a uma e continua o mesmo com a temporada em curso dentro da conta (29,2% dos goleiros contra 7,1% dos atacantes), mas nada disso foi testado — é a contagem da distribuição inteira, e por isso entra como indício.",
    ...
    },
    {
     ...
     "parte": "J01",
     "bloco": "J",
     "manchete": "Minutagem baixa não é enfermaria: a ficha de lesão não distingue quem jogou pouco de quem jogou muito",
     "o_que_vimos": "Entre 2022 e 2025, 138 dos 1.974 jogador-temporadas de minutagem baixa que dá para ligar ao Transfermarkt têm lesão registrada (7%), e entre os 348 de minutagem alta são 26 (7,5%). A diferença é de meio ponto e troca de lado conforme a temporada em curso entre ou não na conta (7% contra 7,5% nas quatro fechadas; 6,9% contra 6,7% com 2026 dentro), então não dá para dizer quem se machuca mais: esta base só enxergaria a lesão se ela aparecesse em mais de 12,3% de quem jogou pouco. Quando há lesão, quem jogou pouco fica 56 dias fora contra 33 de quem jogou muito — diferença que em parte é da própria conta, porque quem fez 60% dos minutos do time não podia ter ficado meio ano parado.",
    ...
    },
    {
     ...
     "parte": "J01",
     "bloco": "J",
     "manchete": "Time que cai roda o elenco inteiro: 45,6 jogadores na temporada contra 38,4 do meio da tabela",
     "o_que_vimos": "Nas quatro temporadas fechadas, os 16 clubes que caíram usaram 45,6 jogadores em média, contra 38,4 dos 48 do meio da tabela; quem subiu usou 36,6 e não se distingue do meio. O mesmo retrato pelo avesso: em quem caiu, 4,3 jogadores por temporada passaram de 60% dos minutos do time, contra 5,8 no meio. Tirando os 28 clubes-temporada que terminaram colados na linha de acesso ou na de rebaixamento, a conta se refaz com 12 que caíram contra 32 do meio e o degrau de quem cai fica maior, não menor.",
   ...
   "conclusoes": [
    {
     ...
     "parte": "J02",
     "bloco": "J",
     "manchete": "69,8% dos minutos da Série B são de jogador que chegou ao clube naquele mesmo ano",
     "o_que_vimos": "Em 2022, 2023, 2024 e 2025, 69,8% dos minutos que dá para identificar foram de jogador que chegou ao clube naquela mesma temporada; sem os times que terminaram colados na linha de corte dá 69,6%, o mesmo retrato. No meio da tabela, quem já estava no clube fica com 32,3% dos minutos — dois terços do tempo de jogo são de gente que chegou naquele ano. É contagem e não comparação: nenhum teste foi feito aqui, e 1 dos 80 clube-temporadas ficou de fora porque as duas bases não se encontraram em minutos suficientes (Athletico-PR 2025).",
    ...
    },
    {
     ...
     "o_que_vimos": "Entre os que subiram, quem já estava no clube ficou com 27% dos minutos, contra 32,3% do meio da tabela; sem os times que terminaram colados na linha de corte é 20,3% contra 31,2%, e nos dois recortes a diferença cabe dentro do que o acaso produz numa amostra deste tamanho. Caso a caso não há padrão nenhum: entre os 15 que subiram a fatia vai de 13,9% (Remo 2025) a 70,1% (Criciúma 2023). Com 15 times que subiram contra 48 do meio — 7 contra 32 sem os de fronteira —, só uma vantagem grande apareceria: não dá para dizer que ela não existe, só que não apareceu.",
    ...
    },
    {
     ...
     "parte": "J02",
     "bloco": "J",
     "manchete": "Quem sobe concentra 68,1% dos minutos nos onze mais usados; quem cai espalha o ano por 47 jogadores",
     "o_que_vimos": "Os onze mais usados de quem sobe ficam com 68,1% dos minutos do time, contra 63,1% do meio da tabela — e sem os times que terminaram colados na linha de corte a diferença cresce, 68,8% contra 62,5%. Quem cai anda no sentido contrário: 47 jogadores usados na temporada contra 38 do meio, 60,2% dos minutos nos onze mais usados contra 63,1% e 24,1% dos minutos com quem já estava no clube contra 32,3% — as três se sustentam sem os times de fronteira (47,5 contra 38,5; 57,5% contra 62,5%; 22,3% contra 31,2%). O que não separa quem sobe do meio, em nenhum dos dois recortes, é o número de jogadores usados: 35 contra 38.",
   ...
   "conclusoes": [
    {
     ...
     "parte": "J03",
     "bloco": "J",
     "manchete": "Procuramos o titular que separa quem sobe, posição por posição, e não achamos nenhum",
     "o_que_vimos": "Comparamos 723 titulares — 179 de quem subiu contra 544 do meio, todos com 900 minutos ou mais na temporada — em 12 números técnicos dentro de cada um dos 7 setores do campo. Rodando com todos os times e de novo sem os que terminaram colados na linha de acesso, onde sobram 456 titulares (91 contra 365), nenhum dos 84 números aparece nos dois recortes; comparando cada titular com quem joga exatamente a mesma posição, como a lista declarada manda, sobra um só — o lateral acertar cerca de um passe a mais em cada cem, 78,9% contra 77,8% com todos os times e 79,5% contra 78,1% sem os colados na linha. É achado fraco de propósito: com este tamanho só uma diferença grande apareceria, e nada aqui diz se o número vem antes do acesso ou depois dele.",
    ...
    },
    {
     ...
     "parte": "J03",
     "bloco": "J",
     "manchete": "O duelo defensivo de quem sobe aparece na conta do time, mas não aponta nenhuma posição para contratar",
     "o_que_vimos": "No time, quem sobe ganha 0,98 ponto percentual a mais de duelo defensivo do que o meio — 60,77% contra 59,78%, em 16 temporadas de quem subiu contra 48 do meio — e sem os times colados na linha de acesso a diferença continua, 61,7% contra 59,9% em 8 contra 32. Posição por posição não sobra nada: a maior é a do volante, 59,87% contra 58,06%, e ela não se distingue da diferença do time inteiro. A única posição que aparece num dos recortes é o gol, e ao contrário: sem os times colados na linha, o goleiro de quem sobe ganha menos duelo defensivo que o do meio.",
    ...
    },
    {
     ...
     "parte": "J03",
     "bloco": "J",
     "manchete": "O goleiro de quem sobe ganha a mesma bola alta que o do meio — o destaque era da porcentagem, não do goleiro",
     "o_que_vimos": "Em porcentagem, o goleiro de quem sobe aparece com 97,9% de bola alta ganha contra 87,9% do meio, o maior número individual da tabela; em bola, os dois ganham o mesmo — 14,6 por temporada contra 14,5 — e a diferença inteira é perder 0,5 contra 2 no ano. Sem os times que terminaram colados na linha de acesso sobram 8 goleiros de quem subiu contra 32 do meio: as porcentagens quase não mudam, 97,9% contra 88,6%, mas com esse tamanho a diferença deixa de se sustentar. Nesse mesmo recorte, o único número do gol que se firma aponta para o outro lado — o goleiro de quem sobe faz 1,4 interceção por jogo contra 2,1 do meio, e com todos os times a conta já ia na mesma direção, 1,7 contra 2,1.",
   ...
   "conclusoes": [
    {
     ...
     "parte": "J04",
     "bloco": "J",
     "manchete": "Procuramos o titular que corre diferente em quem sobe, posição por posição, e não achamos nenhum",
     "o_que_vimos": "Comparei 697 titulares com dado físico, de 2022 a 2025, em 17 medidas de corrida — volume, alta intensidade, sprints e velocidade máxima — nas 6 posições de linha, rodando tudo duas vezes: com todos os times e de novo sem os que terminaram colados na linha do acesso. Das 204 comparações entre quem sobe e o meio, nenhuma sobrevive aos dois recortes: o volante de quem subiu corre 10.031 metros por jogo e o do meio, 10.034; a ponta de quem subiu dá 12,0 sprints por jogo contra 11,8. É achado fraco de propósito — com 8 a 28 titulares de quem sobe em cada posição, conforme o recorte, só uma diferença do tamanho da que aparece na zaga (8.509 contra 8.908 metros por jogo) teria chance de aparecer, então “não achamos” aqui não é “é igual”.",
    ...
    },
    {
     ...
     "parte": "J04",
     "bloco": "J",
     "manchete": "Os dois sinais físicos que sobraram aparecem cada um em um recorte e somem no outro",
     "o_que_vimos": "O volante de quem sobe alcança 27,9 km/h de pico contra 27,5 do meio, mas só com os times que terminaram colados na linha do acesso na conta: sem eles são 27,8 contra 27,6. Na zaga é o contrário — o zagueiro de quem sobe corre 8.509 metros por jogo contra 8.908 do meio só quando esses times saem; com todos na conta são 8.747 contra 8.890. As duas conferências de robustez discordam nos dois casos: tirando os clubes de cobertura física baixa os dois somem (27,6 contra 27,5 no volante, 8.839 contra 8.918 na zaga), e tirando as linhas de identidade duvidosa os dois seguem de pé (27,9 contra 27,4 e 8.509 contra 8.898).",
    ...
    },
    {
     ...
     "parte": "J04",
     "bloco": "J",
     "manchete": "Quem corria mais no primeiro turno corre mais no segundo — e mesmo assim isso não diz quem sobe",
     "o_que_vimos": "Em 2025, a única temporada fechada com dado jogo a jogo, comparei o que 180 titulares correram nas 19 primeiras rodadas com o que correram nas 19 últimas, contando só os jogos em que ficaram 60 minutos ou mais. Quem mais corria no primeiro turno seguiu entre os que mais correm no segundo, nas nove medidas por 90 minutos; na velocidade de pico a repetição é bem menor, mas está lá. É repetição dentro da mesma temporada, que é o teste mais fácil: de um ano para o outro, medida fora desta parte, ela cai e continua alta.",
   ...
   "conclusoes": [
    {
     ...
     "parte": "J07",
     "bloco": "J",
     "manchete": "A vaga de estrangeiro não está sobrando: a Série B já usa 2,3 por clube, e quem sobe põe quase três vezes mais minutos neles que o meio",
     "o_que_vimos": "Nas quatro temporadas fechadas, 63 das 80 clube-temporadas tiveram pelo menos um estrangeiro e a liga usa 2,3 por clube — longe das 9 que o regulamento permite, mas muito longe de zero. Quem subiu deu 10,6% dos minutos do time a estrangeiros contra 3,9% do meio e 4,7% de quem caiu, e tirando os times colados na linha de acesso a distância não encolhe, aumenta: 13,8% contra 4,3%. É leitura de agora e não das quatro temporadas: o uso quase triplicou de 2022 a 2025, de 3,5% para 10,4% dos minutos da liga, 80 dos 184 casos da janela são só de 2025, e em 2023 quem subiu usou menos estrangeiro que o meio, 0,5% contra 1,2%.",
    ...
    },
    {
     ...
     "parte": "J07",
     "bloco": "J",
     "manchete": "O estrangeiro não chega jogando mais que o brasileiro que chega — chega igual, e no ano seguinte só 1 em cada 4 ainda está na Série B",
     "o_que_vimos": "Comparando os dois lados do mesmo jeito, só quem entrou no clube naquele ano, o estrangeiro fica com 16,6% dos minutos do time na estreia e o brasileiro com 16,5% — empate, com 120 estrangeiros contra 1.078 brasileiros. A vantagem de 18,1% contra 16,8% que aparecia antes vem de uma coorte frouxa, em que chegar era só aparecer na base pela primeira vez, e some quando os dois lados são recortados igual; deixando 2022 de fora, ano em que a liga inteira conta como estreante, ela volta a 19,4% contra 15,2%, com 94 estrangeiros. O que não muda em corte nenhum é a saída: 49 dos 184 estrangeiros reaparecem na Série B no ano seguinte (26,6%), contra 1.438 de 2.812 brasileiros (51,1%), e o estrangeiro fica atrás nas quatro temporadas, de 14,7% a 37,7% contra 48,9% a 53,5%.",
    ...
    },
    {
     ...
     "parte": "J07",
     "bloco": "J",
     "manchete": "O estrangeiro da Série B é vizinho: 7 em cada 10 vêm de Argentina, Colômbia, Uruguai ou Paraguai",
     "o_que_vimos": "Nas quatro temporadas fechadas, 159 dos 184 casos de estrangeiro são sul-americanos, e quatro vizinhos respondem por 134 deles: Argentina 43, Colômbia 37, Uruguai 34, Paraguai 20. Contando pessoas em vez de temporadas — o mesmo jogador reaparece em até quatro anos — são 148 estrangeiros e 125 sul-americanos, e a ordem vira outra, com a Colômbia na frente e Argentina e Uruguai empatadas: Colômbia 33, Argentina 28, Uruguai 28, Paraguai 15. A Europa quase não aparece dos dois jeitos: Portugal, com 7 casos e 6 jogadores, é o único europeu com mais de um — e, contados do mesmo jeito, o brasileiro com segundo passaporte (177 casos) e o estrangeiro de fato (184) praticamente empatam, o que derruba a ideia de que na Série B o passaporte europeu era usado ao contrário.",
   ...
   "conclusoes": [
    {
     ...
     "parte": "J08",
     "bloco": "J",
     "manchete": "Não dá para converter o número de um estrangeiro para a Série B: falta caso, e o pouco que aparece muda conforme o corte",
     "o_que_vimos": "Das 310 chegadas à Série B, a maior origem de fora do Brasil tem 8 casos (Colômbia A e Uruguai), e o mínimo para dar número a um país são 10. Somando Série A e Série C ao destino para ganhar casos, 7 países chegam ao mínimo — e aí o maior degrau depende de quem se conta: 7.6 lugares em cada 100 no corte publicado, abaixo dos 9.3 que a escolha do melhor entre 7 produz por sorte; 10,1 contando só quem jogou 900 minutos na chegada, acima do sorteio de cerca de 8; e 9,5 (Uruguai) contando só quem de fato mudou de clube, acima de 8,3. Nenhum desses degraus chega ao tamanho que o desenho enxerga com esse punhado de casos — 12.6 lugares em cada 100 com 10 casos, 10,0 com 16 —, e o número do mesmo país anda de 2,5 a 9,5 conforme o corte.",
    ...
    },
    {
     ...
     "parte": "J08",
     "bloco": "J",
     "manchete": "Divisão de origem não vira desconto nem bônus: o degrau entre A, B e C muda de tamanho conforme quem entra na conta",
     "o_que_vimos": "A leitura anotada em 19/09 dizia que quem sobe da Série C para a B perde nível e quem desce da A para a B ganha; descontando onde o jogador já estava dentro da própria liga, a perda da Série C some (0.1 lugar em cada 100) e o ganho da Série A fica em 3.4. Esse 3.4 é estável nos quatro cortes que o script roda (2,9 a 3,6, sempre com a margem fora do zero) — só que 189 das 737 linhas não são transferência: o jogador ficou no mesmo clube e foi o clube que mudou de divisão (56 subidas da B para a A, 55 da C para a B, 43 quedas da A para a B, 34 da B para a C). Ficando só com os 238 casos de quem de fato mudou de clube e jogou 900 minutos dos dois lados, o ganho da Série A cai para 1.0 lugar em cada 100 e a Série C aparece com -3.5, as duas margens passando pelo zero.",
    ...
    },
    {
     ...
     "o_que_vimos": "Em 737 mudanças de liga, o jogador que era o 10º melhor de 100 na posição dele aparece por volta do 33º de 100 no ano seguinte, e isso vale igual para quem veio de dentro e de fora do Brasil. No que é acerto — passe certo, duelo ganho, conversão — o encolhimento é maior: o 10º de 100 vai para perto do 42º. A mesma conta, montada só com quem chegou até 2024 (222 casos), acerta a ordem dos 515 que chegaram em 2025 e 2026 e erra em média 9.58 lugares em cada 100.",
